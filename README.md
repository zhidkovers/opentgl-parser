...
Скрипт собирает CSV-файлы со страниц 1–3 каталога открытых данных и загружает их в Google Таблицу. Каждому CSV-файлу соответствует отдельный лист, имя листа совпадает с именем файла (без расширения `.csv`).
